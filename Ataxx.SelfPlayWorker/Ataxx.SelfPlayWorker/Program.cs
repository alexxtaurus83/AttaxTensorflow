...
public class Program {
    ...
    public class Options {
        ...
        [Option('g', "games", Default = 40000, HelpText = "The total number of games to simulate per session.")]
        public int NumberOfGames { get; set; }

        [Option('o', "output-path",  Default = @"M:\attax", HelpText = "The directory path to save game log files.")]
        ...
        [Option("model-path", Default = @"M:\attax\model", HelpText = "Required for Mcts mode. The path to the trained model folder (can be UNC).")]
